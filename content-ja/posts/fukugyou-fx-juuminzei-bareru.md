...
faq:
  - q: "副業FXの利益が会社にバレないようにするにはどうすればいいですか？"
    a: "確定申告書（第二表）の住民税の徴収方法で「自分で納付」（普通徴収）を選択してください。FX利益分の住民税が会社経由でなく自分で納付する形になり、会社の経理に金額変動が通知されるリスクを軽減できます。"
  - q: "FXの利益が20万円以下なら何もしなくていいですか？"
    a: "所得税の確定申告は不要ですが、住民税の申告は別途必要です。お住まいの市区町村に住民税の申告をしないと、後から追徴課税を受けるリスクがあります。"
  - q: "副業FXの税率は何%ですか？"
    a: "国内FXの場合、申告分離課税で一律20.315%（所得税15.315%＋住民税5%）です。給与所得の税率に関係なく一定率が適用されます。"
  - q: "FXの経費として認められるものは何ですか？"
    a: "FX取引ツールの利用料、FX関連の書籍・セミナー費用、取引に使用した通信費やPC費用の一部（按分計算が必要）などが経費として計上できます。レシートや領収書の保管が必要です。"
  - q: "FXで損失が出た場合、翌年以降の利益と相殺できますか？"
    a: "はい。確定申告をすることでFXの損失を最大3年間繰り越し、翌年以降の利益と相殺できます（繰越控除）。損失が出た年も必ず確定申告を行ってください。"
---
...
**Q1. 副業FXの利益が会社にバレないようにするにはどうすればいいですか？**
確定申告書（第二表）の住民税の徴収方法で「自分で納付」（普通徴収）を選択してください。FX利益分の住民税が会社経由でなく自分で納付する形になり、会社の経理に金額変動が通知されるリスクを軽減できます。

**Q2. FXの利益が20万円以下なら何もしなくていいですか？**
所得税の確定申告は不要ですが、住民税の申告は別途必要です。お住まいの市区町村に住民税の申告をしないと、後から追徴課税を受けるリスクがあります。

**Q3. 副業FXの税率は何%ですか？**
国内FXの場合、申告分離課税で一律20.315%（所得税15.315%＋住民税5%）です。給与所得の税率に関係なく一定率が適用されます。

**Q4. FXの経費として認められるものは何ですか？**
FX取引ツールの利用料、FX関連の書籍・セミナー費用、取引に使用した通信費やPC費用の一部（按分計算が必要）などが経費として計上できます。レシートや領収書の保管が必要です。

**Q5. FXで損失が出た場合、翌年以降の利益と相殺できますか？**
はい。確定申告をすることでFXの損失を最大3年間繰り越し、翌年以降の利益と相殺できます（繰越控除）。損失が出た年も必ず確定申告を行ってください。
