...
faq:
  - q: "Notionは完全無料で使えますか？"
    a: "はい。個人利用であればフリープランで無制限のページ・ブロック作成が可能です。ファイルアップロードは5MBまでの制限がありますが、基本的な機能は無料で十分に使えます。"
  - q: "NotionとEvernoteの違いは何ですか？"
    a: "Evernoteは主にメモ・ノート管理に特化していますが、Notionはノートに加えてデータベース・タスク管理・Wiki・プロジェクト管理を一つのアプリで実現できます。複数ツールをNotionに集約できる点が最大の違いです。"
  - q: "Notionは日本語に対応していますか？"
    a: "はい。NotionのUIは日本語に完全対応しています。設定から言語を日本語に変更するだけで、メニューやヘルプがすべて日本語表示になります。"
  - q: "スマートフォンだけでもNotionは使えますか？"
    a: "はい。iOS・Android両方に公式アプリがあり、外出先でもメモ作成やタスク管理ができます。ただし、データベースの複雑な設定やテンプレート作成はPC版の方が操作しやすいです。"
  - q: "Notionの学習にどれくらい時間がかかりますか？"
    a: "基本操作（ページ作成・メモ・ToDoリスト）は30分〜1時間で習得できます。データベース機能を使いこなすには1〜2週間程度の実践が目安です。最初から完璧を目指さず、シンプルに始めて少しずつ覚えるのがコツです。"
---
...
**Q1. Notionは完全無料で使えますか？**
はい。個人利用であればフリープランで無制限のページ・ブロック作成が可能です。ファイルアップロードは5MBまでの制限がありますが、基本的な機能は無料で十分に使えます。

**Q2. NotionとEvernoteの違いは何ですか？**
Evernoteは主にメモ・ノート管理に特化していますが、Notionはノートに加えてデータベース・タスク管理・Wiki・プロジェクト管理を一つのアプリで実現できます。複数ツールをNotionに集約できる点が最大の違いです。

**Q3. Notionは日本語に対応していますか？**
はい。NotionのUIは日本語に完全対応しています。設定から言語を日本語に変更するだけで、メニューやヘルプがすべて日本語表示になります。

**Q4. スマートフォンだけでもNotionは使えますか？**
はい。iOS・Android両方に公式アプリがあり、外出先でもメモ作成やタスク管理ができます。ただし、データベースの複雑な設定やテンプレート作成はPC版の方が操作しやすいです。

**Q5. Notionの学習にどれくらい時間がかかりますか？**
基本操作（ページ作成・メモ・ToDoリスト）は30分〜1時間で習得できます。データベース機能を使いこなすには1〜2週間程度の実践が目安です。最初から完璧を目指さず、シンプルに始めて少しずつ覚えるのがコツです。
