...
faq:
  - q: "共働き夫婦の家計管理はどのモデルがおすすめですか？"
    a: "最もおすすめは完全合算型（2人の収入を合算し、そこから生活費・貯蓄・お小遣いを配分）です。家計の全体像が見えやすく貯蓄効率が最も高いモデルです。個人の自由なお金はお小遣い制で確保すれば、ストレスなく運用できます。"
  - q: "Excel家計簿と家計管理アプリはどちらがいいですか？"
    a: "日々の記録はアプリ（Money Forward MEなど）の自動連携が便利ですが、月次分析・グラフ化・目標管理はExcelのカスタマイズ性が優れています。おすすめは両方を併用する方法です。口座情報をアプリに渡すことに抵抗がある場合はExcel一本でも問題ありません。"
  - q: "共働き家計簿でよくある失敗は何ですか？"
    a: "最も多い失敗は①記録が続かないこと、②特別費（車検・旅行・家電）の積立を忘れること、③クレカの使い分けが複雑すぎることです。記録のハードルを下げ（1000円未満は省略OK）、特別費は毎月定額で別口座に積み立てるのが対策です。"
  - q: "家計簿を夫婦で続けるコツはありますか？"
    a: "月末に30分の『家計会議』を定例化することが最大のコツです。今月の収支振り返り・予算オーバーの確認・来月の特別支出の確認を行うだけで家計への意識が劇的に変わります。記録担当を明確に決め、完璧を求めず継続優先にするのも重要です。"
  - q: "共働き夫婦の理想的な貯蓄率はどのくらいですか？"
    a: "手取り合計の20〜30%を貯蓄・投資に回せるのが理想です。ただし住宅ローン返済中や子育て中は15%程度でも十分です。まずは現状の貯蓄率を把握し、年間貯蓄目標を設定して進捗をExcelで可視化することから始めてください。"
---
...
**Q1. 共働き夫婦の家計管理はどのモデルがおすすめですか？**
最もおすすめは完全合算型（2人の収入を合算し、そこから生活費・貯蓄・お小遣いを配分）です。家計の全体像が見えやすく貯蓄効率が最も高いモデルです。個人の自由なお金はお小遣い制で確保すれば、ストレスなく運用できます。

**Q2. Excel家計簿と家計管理アプリはどちらがいいですか？**
日々の記録はアプリ（Money Forward MEなど）の自動連携が便利ですが、月次分析・グラフ化・目標管理はExcelのカスタマイズ性が優れています。おすすめは両方を併用する方法です。口座情報をアプリに渡すことに抵抗がある場合はExcel一本でも問題ありません。

**Q3. 共働き家計簿でよくある失敗は何ですか？**
最も多い失敗は①記録が続かないこと、②特別費（車検・旅行・家電）の積立を忘れること、③クレカの使い分けが複雑すぎることです。記録のハードルを下げ（1000円未満は省略OK）、特別費は毎月定額で別口座に積み立てるのが対策です。

**Q4. 家計簿を夫婦で続けるコツはありますか？**
月末に30分の「家計会議」を定例化することが最大のコツです。今月の収支振り返り・予算オーバーの確認・来月の特別支出の確認を行うだけで家計への意識が劇的に変わります。記録担当を明確に決め、完璧を求めず継続優先にするのも重要です。

**Q5. 共働き夫婦の理想的な貯蓄率はどのくらいですか？**
手取り合計の20〜30%を貯蓄・投資に回せるのが理想です。ただし住宅ローン返済中や子育て中は15%程度でも十分です。まずは現状の貯蓄率を把握し、年間貯蓄目標を設定して進捗をExcelで可視化することから始めてください。
