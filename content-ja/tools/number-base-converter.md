...
ShowToc: false
cover:
  image: "/images/covers/number-base-converter-ja.png"
  alt: "進数変換ツール"
---
...
> 行列計算 → [行列計算ツール](/ja/tools/matrix-calculator/)

> **確定申告・会計をもっとラクに？** [freee会計](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) なら、フリーランスの経費管理もクラウドで簡単。まずは無料で試してみましょう。

<div class="nb-freee-cta" style="margin-top:28px;padding:18px 20px;background:linear-gradient(135deg,#f0f9ff 0%,#e0f2fe 100%);border:1.5px solid #bae6fd;border-radius:10px;">
