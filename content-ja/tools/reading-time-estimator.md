...
ShowToc: false
cover:
  image: "/images/covers/reading-time-estimator-ja.png"
  alt: "読了時間推定ツール"
---
...
<div id="rte-app">
  ...
  <div class="rte-difficulty-section">
    ...
    <p class="rte-hint">1文あたりの単語数と単語の長さに基づいて算出</p>
  </div>

  <button class="rte-clear-btn" id="rte-clear-btn">テキストをクリア</button>
  ...
  (function() {
    ...
    function calcDifficulty(text, words, sentences) {
      ...
      var labels = ['とても易しい', '易しい', '普通', 'やや難しい', '難しい'];
