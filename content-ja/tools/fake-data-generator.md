...
ShowToc: false
cover:
  image: "/images/covers/fake-data-generator-ja.png"
  alt: "ダミーデータジェネレーター"
---
...
> JSONを整形する → [JSONフォーマッター](/ja/tools/json-formatter/)

> ダミーテキストを生成 → [ローレム・イプサムジェネレーター](/ja/tools/lorem-ipsum-generator/)

> CSVをJSONに変換 → [CSV to JSON](/ja/tools/csv-to-json/)
