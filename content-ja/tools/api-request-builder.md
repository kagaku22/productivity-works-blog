---
title: "APIリクエストビルダー - cURL・Fetch・Axiosコード生成"
date: 2025-07-19
...
<div class="arb-cta">
<p>API連携を効率化 &rarr; <a href="https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP" target="_blank" rel="noopener">freee APIで会計業務を自動化</a></p>
</div>
...
'<td class="arb-kv-td-key"><input type="text" class="arb-kv-input" id="arbk-' + id + '" placeholder="キー" value="' + esc(key||'') + '"></td>' +
'<td><input type="text" class="arb-kv-input" id="arbv-' + id + '" placeholder="値" value="' + esc(val||'') + '"></td>' +
...
fields.innerHTML = '';
if (type === 'bearer') {
fields.innerHTML = '<div class="arb-auth-field-row"><span class="arb-auth-label">トークン</span><input type="text" class="arb-auth-input" id="arb-auth-token" placeholder="Bearerトークンを入力"></div>';
} else if (type === 'basic') {
fields.innerHTML = '<div class="arb-auth-field-row"><span class="arb-auth-label">ユーザー名</span><input type="text" class="arb-auth-input" id="arb-auth-user" placeholder="username"></div>' +
'<div class="arb-auth-field-row"><span class="arb-auth-label">パスワード</span><input type="password" class="arb-auth-input" id="arb-auth-pass" placeholder="password"></div>';
} else if (type === 'apikey') {
fields.innerHTML = '<div class="arb-auth-field-row"><span class="arb-auth-label">キー名</span><input type="text" class="arb-auth-input" id="arb-auth-key-name" placeholder="X-API-Key"></div>' +
'<div class="arb-auth-field-row"><span class="arb-auth-label">値</span><input type="text" class="arb-auth-input" id="arb-auth-key-val" placeholder="APIキーを入力"></div>' +
'<div class="arb-auth-field-row"><span class="arb-auth-label">送信先</span><select class="arb-auth-input" id="arb-auth-key-loc" style="font-family:inherit"><option value="header">ヘッダー</option><option value="query">クエリパラメータ</option></select></div>';
}
};
...
if (!code || code.indexOf('コードを生成') >= 0) return;
