...
<div class="qr-freee-cta" style="margin-top:28px;padding:18px 20px;background:linear-gradient(135deg,#f0f9ff 0%,#e0f2fe 100%);border:1.5px solid #bae6fd;border-radius:10px;">
...
> 名刺作成 → [名刺ジェネレーター](/ja/tools/business-card-generator/)
