...
1. **Prompt 1** — Write your next property description (you'll see the ROI immediately)
2. **Prompt 6** — Set up an inquiry response email template for each active listing
3. **Prompt 11** — Write a neighborhood market update for your newsletter
4. **Prompt 17** — Create a just-listed Instagram caption for your next listing
5. **Prompt 22** — Rewrite your agent bio
