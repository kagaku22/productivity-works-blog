...
tags: ["kakuteishinkoku", "FX income", "Japan tax filing", "tax return", "e-Tax"]
...
The easiest and most reliable way to file is through **e-Tax**, the NTA's online filing system at [https://www.e-tax.nta.go.jp/](https://www.e-tax.nta.go.jp/). Here is how to complete the process from scratch.
...
Navigate to [https://www.e-tax.nta.go.jp/](https://www.e-tax.nta.go.jp/) and select **確定申告書等作成コーナー** (Tax Return Preparation Corner). You will be prompted to authenticate:
...
1. **確定申告書B (Form B)** — This is the general-purpose form used for all income types other than employment-only filers.
2. **第三表 (Schedule 3: 分離課税用)** — The separate taxation schedule. Selecting this will add the FX income section to your return.
...
If you have multiple income streams — freelance income, rental income, or investment income alongside FX — manually preparing Schedule 3 and the supporting worksheets can become time-consuming. [freee](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) can generate your filing documents and submit directly to e-Tax, consolidating all your income sources into a single, submission-ready return. It supports Schedule 3 and the futures transactions attachment, which makes it particularly useful for FX traders who also have business or freelance income.
