...
1. Student submits written work
...
4. Teacher reviews the AI feedback, adjusts for accuracy and appropriateness, adds their personal observations, and delivers it
...
Our **ChatGPT Prompt Templates pack** on [Payhip](https://payhip.com) includes an educator-specific section with 30+ classroom-ready AI prompts for teachers, including lesson planning, assessment design, differentiation, and parent communication templates — pre-tested and ready to use.
