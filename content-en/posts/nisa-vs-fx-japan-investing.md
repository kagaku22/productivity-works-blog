...
tags: ["NISA", "FX", "Japan investing", "tax comparison", "beginner"]
...
1. Adding up all FX realized gains and losses for the calendar year
2. Subtracting any eligible losses from prior years carried forward
3. Applying the 20.315% rate to the net gain
4. Paying the resulting tax by the March 15 deadline (or setting up installments)

For those filing in Japanese, the National Tax Agency (NTA) provides an online e-Tax portal. For English-language support and to simplify the calculation, [freee](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) simplifies FX tax filing for English speakers. The platform supports FX income reporting in a guided workflow, making it significantly more accessible for expats and non-native Japanese speakers navigating the Kakutei Shinkoku process for the first time.
