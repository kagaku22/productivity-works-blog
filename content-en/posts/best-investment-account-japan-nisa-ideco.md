...
You can model your own numbers using the [NISA Simulator](/ja/tools/compound-interest-calculator/) on this site. Here is the exact process:

1. Open the [NISA Simulator](/ja/tools/compound-interest-calculator/).
