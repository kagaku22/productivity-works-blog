...
tags: ["FX losses", "tax carryforward", "Japan tax", "kakuteishinkoku"]
...
Losing money on FX is painful. You watched the market move against you, cut your position, and ended up with a net loss for the year. It stings — but before you write off that loss entirely, Japan's tax code offers a genuinely useful silver lining: **you can carry forward FX losses for up to three years and use them to offset future profits**.
...
For traders who are non-Japanese speakers or who have multiple income sources to reconcile, [freee](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) makes filing in Japan manageable for English speakers. It guides you through the relevant schedules, handles the separate taxation classification, and supports carryforward entry — without requiring you to interpret Japanese tax forms from scratch.
...
1. File every year — even in a zero-profit year.
2. Use Schedule 3 and the futures transactions attachment form.
3. Do not skip a single year during the carryforward period.
4. Only FX, CFD, and futures instruments are eligible — not stocks, NISA, or crypto.
