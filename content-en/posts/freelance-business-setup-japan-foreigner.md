---
title: "Setting Up a Freelance Business in Japan: Domain, Registration, and Accounting in One Weekend"
date: 2026-05-15
draft: false
slug: "freelance-business-setup-japan-foreigner"
description: "A practical, step-by-step guide for foreigners in Japan who want to go freelance. Covers legal structure, domain setup via お名前.com, filing the 開業届, and using freee for accounting from day one."
categories: ["Money & Work", "Japan Living Guide"]
tags: ["freelance", "Japan", "sole proprietor", "開業届", "freee", "kakuteishinkoku", "expat", "business setup"]
...
cover:
  image: "images/covers/freelance-business-setup-japan-foreigner.png"
  alt: "Setting Up a Freelance Business in Japan: Domain, Registration, and Accounting in One Weekend"
  relative: false
---
...
## 1. Legal Structure Options for Foreigners Freelancing in Japan
...
[お名前.com](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+29KENM+50+2HU3GX) is Japan's largest domain registrar and one of the most widely used by small businesses and freelancers. The interface is available in Japanese, but navigation is straightforward even for non-Japanese readers.

**Step-by-step:**

1. Go to [お名前.com](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+29KENM+50+2HU3GX) and search for your desired domain name.
...
The single most common mistake new freelancers make is treating accounting as something to worry about in February. By then, you have twelve months of bank statements, receipts, and invoices to reconstruct from memory. Starting [freee](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) on day one means your books are always current, and kakuteishinkoku becomes a matter of reviewing and submitting rather than a week-long audit of your own finances.

### What freee Does

[freee](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) (pronounced "free") is Japan's leading cloud accounting platform for small businesses and sole proprietors. Its core functions include:
...
**Step 1: Create your account.** Go to [freee](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+7YYYCY+3SPO+9FHKUP) and sign up. Select "個人事業主" as your business type. The interface has an English-language option, though some tax-specific terminology remains in Japanese.
...
- [ ] Register your domain at [お名前.com](https://px.a8.net/svt/ejp?a8mat=4B3QAZ+29KENM+50+2HU3GX). Enable Whois privacy.
