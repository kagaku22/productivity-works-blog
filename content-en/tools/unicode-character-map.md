---
title: "Unicode Character Map — Symbol Finder"
date: 2025-05-16
...
ShowToc: false
cover:
  image: "/images/covers/unicode-character-map.png"
...
- [HTML Entity Encoder](/tools/html-entity-encoder/) — encode and decode HTML entities in bulk
- [Emoji Picker](/tools/emoji-picker/) — browse and copy emoji with skin-tone and keyword search
- [Morse Code Translator](/tools/morse-code-translator/) — convert text to Morse code and back
