...
ShowToc: false
cover:
  image: "/images/covers/glassmorphism-generator.png"
  alt: "Glassmorphism Generator"
---
...
<div class="gm-panel">
<div>
<p class="gm-panel-title">Presets</p>
<div class="gm-presets">
<button class="gm-preset-btn active" data-preset="frost">Frost</button>
<button class="gm-preset-btn" data-preset="ocean">Ocean</button>
<button class="gm-preset-btn" data-preset="sunset">Sunset</button>
<button class="gm-preset-btn" data-preset="midnight">Midnight</button>
<button class="gm-preset-btn" data-preset="forest">Forest</button>
</div>
</div>
...
<div><strong>backdrop-filter</strong> is supported in Chrome 76+, Firefox 103+, Safari 9+, Edge 17+. Prefix: <code style="background:#dcfce7;padding:1px 5px;border-radius:3px;font-size:11px;">-webkit-backdrop-filter</code> for older Safari.</div>
</div>
...
// Very simple tokenizer for CSS display
return css
...
> Generate box shadows → [Box Shadow Generator](/tools/box-shadow-generator/)
> Create gradients → [CSS Gradient Generator](/tools/css-gradient-generator/)
> Build buttons → [CSS Button Generator](/tools/css-button-generator/)
