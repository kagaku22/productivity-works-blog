---
title: "Emoji Search & Copy Tool"
date: 2025-05-16
description: "Free emoji search tool. Search 1500+ emojis by keyword. Browse by category, copy with one click. Shows emoji name, Unicode code point, and HTML entity."
categories: ["Free Tools"]
tags: ["emoji search", "emoji copy", "emoji tool", "emoji unicode", "free tool"]
slug: "emoji-search"
cover:
  image: "/images/covers/emoji-search.png"
  alt: "Emoji Search & Copy Tool"
ShowToc: false
---
...
<div class="es-hero">
  ...
  <p>Search 1500+ emojis — click any emoji to copy instantly</p>
</div>

<div class="es-search-row">
  <input id="es-search" class="es-search" type="text" placeholder="Search emojis... (e.g. heart, fire, cat)" oninput="esSearch()" autocomplete="off" spellcheck="false">
  <div class="es-tone-wrap">
    <span class="es-tone-label">Skin:</span>
    <div class="es-tone-buttons">
      <button class="es-tone-btn active" onclick="esSetTone(this,'')" title="Default">&#x270B;</button>
      <button class="es-tone-btn" onclick="esSetTone(this,'1F3FB')" title="Light" style="background:#fde8cd">&#x270B;&#x1F3FB;</button>
      <button class="es-tone-btn" onclick="esSetTone(this,'1F3FC')" title="Medium-Light" style="background:#f3c89a">&#x270B;&#x1F3FC;</button>
      <button class="es-tone-btn" onclick="esSetTone(this,'1F3FD')" title="Medium" style="background:#d4a574">&#x270B;&#x1F3FD;</button>
      <button class="es-tone-btn" onclick="esSetTone(this,'1F3FE')" title="Medium-Dark" style="background:#a0714f">&#x270B;&#x1F3FE;</button>
      <button class="es-tone-btn" onclick="esSetTone(this,'1F3FF')" title="Dark" style="background:#5c3d2e">&#x270B;&#x1F3FF;</button>
    </div>
  </div>
</div>

<div class="es-tabs" id="es-tabs"></div>

<div id="es-recent-box" class="es-recent-box" style="display:none">
  <div class="es-section-label">Recently Used</div>
  <div class="es-recent-row" id="es-recent-row"></div>
</div>

<div id="es-detail" class="es-detail">
  <div class="es-detail-inner">
    <div class="es-preview" id="es-preview">&#x1F600;</div>
    <div class="es-info">
      <div class="es-info-name" id="es-info-name">Grinning Face</div>
      <div class="es-info-row">
        <span class="es-info-label">Unicode</span>
        <span class="es-info-val" id="es-info-cp">U+1F600</span>
        <button class="es-copy-btn" onclick="esCopyVal('es-info-cp')">Copy</button>
      </div>
      <div class="es-info-row">
        <span class="es-info-label">HTML Entity</span>
        <span class="es-info-val" id="es-info-html">&#amp;#128512;</span>
        <button class="es-copy-btn" onclick="esCopyVal('es-info-html')">Copy</button>
      </div>
      <div class="es-info-row">
        <span class="es-info-label">CSS Value</span>
        <span class="es-info-val" id="es-info-css">\1F600</span>
        <button class="es-copy-btn" onclick="esCopyVal('es-info-css')">Copy</button>
      </div>
      <button class="es-copy-emoji-btn" onclick="esCopySelected()">Copy Emoji</button>
    </div>
  </div>
</div>

<div class="es-grid-box">
  <div class="es-count" id="es-count"></div>
  <div class="es-grid" id="es-grid"></div>
  <div class="es-empty" id="es-empty" style="display:none">No emojis found. Try a different keyword.</div>
</div>

<div class="es-toast" id="es-toast"></div>
...
(function() {
  ...
  var ES_TONES = ['1F3FB','1F3FC','1F3FD','1F3FE','1F3FF'];

  // Full emoji dataset: [emoji, name, categories...]
  // Format: [char, name, cat]
  // cat: smileys|people|animals|food|travel|activities|objects|symbols|flags
  var ES_DATA = [
    // Smileys & Emotion
    ...
    ['\u{1F636}\u{200D}\u{1F32B}','face in clouds','smileys'],
    ...
    ['\u{1FAF0}','pinched fingers','people'],
    ['\u{1F90F}','pinching hand','people'],
    ['\u{270C}','victory hand','people'],
    ['\u{1F91E}','crossed fingers','people'],
    ['\u{1FAF0}','hand with index finger and thumb crossed','people'],
    ...
    ['\u{1F9D4}\u{200D}\u{2642}','man beard','people'],
    ['\u{1F9D4}\u{200D}\u{2640}','woman beard','people'],
    ['\u{1F468}\u{200D}\u{1F9B0}','man red hair','people'],
    ['\u{1F468}\u{200D}\u{1F9B1}','man curly hair','people'],
    ['\u{1F468}\u{200D}\u{1F9B3}','man white hair','people'],
    ['\u{1F468}\u{200D}\u{1F9B2}','man bald','people'],
    ['\u{1F469}','woman','people'],
    ['\u{1F469}\u{200D}\u{1F9B0}','woman red hair','people'],
    ['\u{1F9D1}\u{200D}\u{1F9B0}','person red hair','people'],
    ['\u{1F469}\u{200D}\u{1F9B1}','woman curly hair','people'],
    ['\u{1F9D1}\u{200D}\u{1F9B1}','person curly hair','people'],
    ['\u{1F469}\u{200D}\u{1F9B3}','woman white hair','people'],
    ['\u{1F9D1}\u{200D}\u{1F9B3}','person white hair','people'],
    ['\u{1F469}\u{200D}\u{1F9B2}','woman bald','people'],
    ['\u{1F9D1}\u{200D}\u{1F9B2}','person bald','people'],
    ...
    ['\u{1FAC5}','ninja','people'],
    ['\u{1F477}','construction worker','people'],
    ['\u{1FAC5}','person with crown','people'],
    ...
    ['\u{1FAC3}','pregnant person','people'],
    ['\u{1FAC4}','pregnant man','people'],
    ['\u{1F931}','breast-feeding','people'],
    ['\u{1F469}\u{200D}\u{1F37C}','woman feeding baby','people'],
    ['\u{1F468}\u{200D}\u{1F37C}','man feeding baby','people'],
    ...
    ['\u{1F9D1}\u{200D}\u{1F9AF}','person with white cane','people'],
    ['\u{1F9D1}\u{200D}\u{1F9BC}','person in motorized wheelchair','people'],
    ['\u{1F9D1}\u{200D}\u{1F9BD}','person in manual wheelchair','people'],
    ...
    ['\u{1F9D1}\u{200D}\u{1F91D}\u{200D}\u{1F9D1}','people holding hands','people'],
    ...
    ['\u{1F415}','dog','animals'],
    ['\u{1F9AE}','guide dog','animals'],
    ['\u{1F415}\u{200D}\u{1F9BA}','service dog','animals'],
    ...
    ['\u{1FACE}','moose','animals'],
    ['\u{1FACF}','donkey','animals'],
    ...
    ['\u{1FAB8}','coral','animals'],
    ['\u{1FABC}','jellyfish','animals'],
    ...
    ['\u{1FAB9}','empty nest','animals'],
    ['\u{1FABA}','nest with eggs','animals'],
    ['\u{1F344}','mushroom','animals'],
    ['\u{1FAB8}','coral','animals'],
    ['\u{1F30D}','globe showing Europe-Africa','animals'],
    ['\u{1F30E}','globe showing Americas','animals'],
    ['\u{1F30F}','globe showing Asia-Australia','animals'],
    ['\u{1F310}','globe with meridians','animals'],
    ['\u{1F30B}','volcano','animals'],
    ['\u{1F5FB}','mount fuji','animals'],
    ['\u{26F0}','mountain','animals'],
    ['\u{1F3D4}','snow-capped mountain','animals'],
    ['\u{1F3D5}','camping','animals'],
    ['\u{1F3D6}','beach with umbrella','animals'],
    ['\u{1F3DC}','desert','animals'],
    ['\u{1F3DD}','desert island','animals'],
    ['\u{1F3DE}','national park','animals'],
    ['\u{1F307}','sunset','animals'],
    ['\u{1F303}','night with stars','animals'],
    ['\u{1F304}','sunrise over mountains','animals'],
    ['\u{1F305}','sunrise','animals'],
    ['\u{1F306}','cityscape at dusk','animals'],
    ['\u{1F3D9}','cityscape','animals'],
    ['\u{1F30C}','milky way','animals'],
    ['\u{1F309}','bridge at night','animals'],
    ['\u{26A1}','lightning','animals'],
    ['\u{1F300}','cyclone','animals'],
    ['\u{1F308}','rainbow','animals'],
    ['\u{2614}','umbrella with rain drops','animals'],
    ['\u{26C4}','snowman without snow','animals'],
    ...
    ['\u{1F96C}','leafy green','food'],
    ['\u{1F966}','broccoli','food'],
    ['\u{1F9C4}','garlic','food'],
    ['\u{1F9C5}','onion','food'],
    ['\u{1F344}','mushroom','food'],
    ['\u{1F95C}','peanuts','food'],
    ['\u{1FAD8}','beans','food'],
    ['\u{1F330}','chestnut','food'],
    ['\u{1FADA}','ginger root','food'],
    ['\u{1FADB}','pea pod','food'],
    ['\u{1F35E}','bread','food'],
    ['\u{1F950}','croissant','food'],
    ['\u{1F956}','baguette bread','food'],
    ['\u{1FAD3}','flatbread','food'],
    ...
    ['\u{1F958}','shallow pan of food','food'],
    ...
    ['\u{1FAD7}','pouring liquid','food'],
    ['\u{1F964}','cup with straw','food'],
    ['\u{1F9CB}','bubble tea','food'],
    ['\u{1F9C3}','beverage box','food'],
    ['\u{1F9C9}','mate','food'],
    ['\u{1F9CA}','ice','food'],
    ['\u{1F962}','chopsticks','food'],
    ['\u{1F37D}','fork and knife with plate','food'],
    ...
    ['\u{1F6D5}','hindu temple','travel'],
    ['\u{1F54D}','synagogue','travel'],
    ['\u{26E9}','shinto shrine','travel'],
    ...
    ['\u{1F304}','sunrise over mountains','travel'],
    ['\u{1F305}','sunrise','travel'],
    ['\u{1F306}','cityscape at dusk','travel'],
    ['\u{1F307}','sunset','travel'],
    ['\u{1F309}','bridge at night','travel'],
    ['\u{2668}','hot springs','travel'],
    ['\u{1F30C}','milky way','travel'],
    ['\u{1F3A0}','carousel horse','travel'],
    ['\u{1F6DD}','playground slide','travel'],
    ['\u{1F3A1}','ferris wheel','travel'],
    ['\u{1F3A2}','roller coaster','travel'],
    ['\u{1F488}','barber pole','travel'],
    ['\u{1F3AA}','circus tent','travel'],
    ...
    ['\u{1F688}','light rail','travel'],
    ['\u{1F689}','station','travel'],
    ['\u{1F68A}','tram','travel'],
    ['\u{1F69D}','monorail','travel'],
    ['\u{1F69E}','mountain railway','travel'],
    ['\u{1F68B}','tram car','travel'],
    ['\u{1F68C}','bus','travel'],
    ['\u{1F68D}','oncoming bus','travel'],
    ['\u{1F68E}','trolleybus','travel'],
    ['\u{1F690}','minibus','travel'],
    ['\u{1F691}','ambulance','travel'],
    ['\u{1F692}','fire engine','travel'],
    ['\u{1F693}','police car','travel'],
    ['\u{1F694}','oncoming police car','travel'],
    ['\u{1F695}','taxi','travel'],
    ['\u{1F696}','oncoming taxi','travel'],
    ['\u{1F697}','automobile','travel'],
    ['\u{1F698}','oncoming automobile','travel'],
    ['\u{1F699}','sport utility vehicle','travel'],
    ['\u{1F6FB}','pickup truck','travel'],
    ['\u{1F69A}','delivery truck','travel'],
    ['\u{1F69B}','articulated lorry','travel'],
    ['\u{1F69C}','tractor','travel'],
    ['\u{1F3CE}','racing car','travel'],
    ['\u{1F3CD}','motorcycle','travel'],
    ['\u{1F6F5}','motor scooter','travel'],
    ['\u{1F9BD}','manual wheelchair','travel'],
    ['\u{1F6FA}','auto rickshaw','travel'],
    ['\u{1F6B2}','bicycle','travel'],
    ['\u{1F6F4}','kick scooter','travel'],
    ['\u{1F6F9}','skateboard','travel'],
    ['\u{1F6FC}','roller skate','travel'],
    ['\u{1F68F}','bus stop','travel'],
    ['\u{1F6E3}','motorway','travel'],
    ['\u{1F6E4}','railway track','travel'],
    ['\u{1F6E2}','oil drum','travel'],
    ['\u{26FD}','fuel pump','travel'],
    ['\u{1F6DE}','wheel','travel'],
    ['\u{1F6A8}','police car light','travel'],
    ['\u{1F6A5}','horizontal traffic light','travel'],
    ['\u{1F6A6}','vertical traffic light','travel'],
    ['\u{1F6D1}','stop sign','travel'],
    ['\u{1F6A7}','construction','travel'],
    ['\u{2693}','anchor','travel'],
    ['\u{1F6DF}','ring buoy','travel'],
    ['\u{26F5}','sailboat','travel'],
    ['\u{1F6F6}','canoe','travel'],
    ['\u{1F6A4}','speedboat','travel'],
    ['\u{1F6F3}','passenger ship','travel'],
    ['\u{26F4}','ferry','travel'],
    ['\u{1F6E5}','motor boat','travel'],
    ['\u{1F6A2}','ship','travel'],
    ['\u{2708}','airplane','travel'],
    ['\u{1F6E9}','small airplane','travel'],
    ['\u{1F6EB}','airplane departure','travel'],
    ['\u{1F6EC}','airplane arrival','travel'],
    ['\u{1FA82}','parachute','travel'],
    ['\u{1F4BA}','seat','travel'],
    ['\u{1F681}','helicopter','travel'],
    ['\u{1F69F}','suspension railway','travel'],
    ['\u{1F6A0}','mountain cableway','travel'],
    ['\u{1F6A1}','aerial tramway','travel'],
    ['\u{1F6F0}','satellite','travel'],
    ['\u{1F680}','rocket','travel'],
    ['\u{1F6F8}','flying saucer','travel'],
    ['\u{1F6CE}','bellhop bell','travel'],
    ['\u{1F9F3}','luggage','travel'],
    ['\u{231B}','hourglass done','travel'],
    ['\u{23F3}','hourglass not done','travel'],
    ['\u{231A}','watch','travel'],
    ['\u{23F0}','alarm clock','travel'],
    ['\u{23F1}','stopwatch','travel'],
    ['\u{23F2}','timer clock','travel'],
    ...
    ['\u{1F38B}','tanabata tree','activities'],
    ['\u{1F38D}','pine decoration','activities'],
    ['\u{1F38E}','japanese dolls','activities'],
    ['\u{1F38F}','carp streamer','activities'],
    ['\u{1F390}','wind chime','activities'],
    ['\u{1F391}','moon viewing ceremony','activities'],
    ['\u{1F9E7}','red envelope','activities'],
    ['\u{1F380}','ribbon','activities'],
    ['\u{1F381}','wrapped gift','activities'],
    ['\u{1F397}','reminder ribbon','activities'],
    ['\u{1F39F}','admission tickets','activities'],
    ['\u{1F3AB}','ticket','activities'],
    ...
    ['\u{1F93F}','diving mask','activities'],
    ['\u{1F3BD}','running shirt','activities'],
    ['\u{1F3BF}','skis','activities'],
    ['\u{1F6F7}','sled','activities'],
    ['\u{1F94C}','curling stone','activities'],
    ...
    ['\u{1FA85}','pinata','activities'],
    ['\u{1FAA9}','mirror ball','activities'],
    ['\u{1FA86}','nesting dolls','activities'],
    ['\u{2660}','spade suit','activities'],
    ['\u{2665}','heart suit','activities'],
    ['\u{2666}','diamond suit','activities'],
    ['\u{2663}','club suit','activities'],
    ['\u{265F}','chess pawn','activities'],
    ['\u{1F0CF}','joker','activities'],
    ['\u{1F004}','mahjong red dragon','activities'],
    ['\u{1F3B4}','flower playing cards','activities'],
    ...
    ['\u{1FAA1}','sewing needle','activities'],
    ['\u{1F9F6}','yarn','activities'],
    ['\u{1FAA2}','knot','activities'],

    // Objects
    ['\u{1F453}','glasses','objects'],
    ['\u{1F576}','sunglasses','objects'],
    ['\u{1F97D}','goggles','objects'],
    ['\u{1F97C}','lab coat','objects'],
    ['\u{1F9BA}','safety vest','objects'],
    ...
    ['\u{1FA71}','one-piece swimsuit','objects'],
    ['\u{1FA72}','briefs','objects'],
    ['\u{1FA73}','shorts','objects'],
    ['\u{1F459}','bikini','objects'],
    ['\u{1F45A}','womans clothes','objects'],
    ['\u{1FAAD}','folding hand fan','objects'],
    ...
    ['\u{1FA98}','long drum','objects'],
    ['\u{1FA87}','maracas','objects'],
    ['\u{1FA88}','flute','objects'],
    ['\u{1F4F1}','mobile phone','objects'],
    ['\u{1F4F2}','mobile phone with arrow','objects'],
    ['\u{260E}','telephone','objects'],
    ['\u{1F4DE}','telephone receiver','objects'],
    ['\u{1F4DF}','pager','objects'],
    ['\u{1F4E0}','fax machine','objects'],
    ['\u{1F50B}','battery','objects'],
    ['\u{1FAAB}','low battery','objects'],
    ...
    ['\u{1F5B1}','computer mouse','objects'],
    ['\u{1F5B2}','trackball','objects'],
    ...
    ['\u{1F39E}','film frames','objects'],
    ['\u{1F4FD}','film projector','objects'],
    ['\u{1F3AC}','clapper board','objects'],
    ...
    ['\u{1F4E4}','outbox tray','objects'],
    ['\u{1F4E5}','inbox tray','objects'],
    ['\u{1F4E6}','package','objects'],
    ['\u{1F4EB}','closed mailbox with raised flag','objects'],
    ['\u{1F4EC}','open mailbox with raised flag','objects'],
    ['\u{1F4ED}','open mailbox with lowered flag','objects'],
    ['\u{1F4EE}','closed mailbox with lowered flag','objects'],
    ['\u{1F5F3}','ballot box with ballot','objects'],
    ...
    ['\u{1F5C2}','card index dividers','objects'],
    ['\u{1F4C5}','calendar','objects'],
    ['\u{1F4C6}','tear-off calendar','objects'],
    ['\u{1F5D2}','spiral notepad','objects'],
    ['\u{1F5D3}','spiral calendar','objects'],
    ...
    ['\u{1F587}','linked paperclips','objects'],
    ['\u{1F4CF}','straight ruler','objects'],
    ['\u{1F4D0}','triangular ruler','objects'],
    ['\u{2702}','scissors','objects'],
    ['\u{1F5C3}','card file box','objects'],
    ['\u{1F5C4}','file cabinet','objects'],
    ['\u{1F5D1}','wastebasket','objects'],
    ['\u{1F512}','locked','objects'],
    ['\u{1F513}','unlocked','objects'],
    ['\u{1F50F}','locked with pen','objects'],
    ['\u{1F510}','locked with key','objects'],
    ['\u{1F511}','key','objects'],
    ...
    ['\u{1FAA4}','mouse trap','objects'],
    ['\u{1F9FD}','sponge','objects'],
    ['\u{1F9EF}','fire extinguisher','objects'],
    ['\u{1F6D2}','shopping cart','objects'],
    ['\u{1F6AC}','cigarette','objects'],
    ['\u{26B1}','funeral urn','objects'],
    ['\u{1F5FF}','moai','objects'],
    ['\u{1FAA7}','placard','objects'],
    ['\u{1FAB9}','empty nest','objects'],

    // Symbols
    ['\u{1F3E7}','atm sign','symbols'],
    ['\u{1F6AE}','litter in bin sign','symbols'],
    ['\u{1F6B0}','potable water','symbols'],
    ['\u{267F}','wheelchair symbol','symbols'],
    ['\u{1F6B9}','mens room','symbols'],
    ['\u{1F6BA}','womens room','symbols'],
    ['\u{1F6BB}','restroom','symbols'],
    ['\u{1F6BC}','baby symbol','symbols'],
    ['\u{1F6BE}','water closet','symbols'],
    ['\u{1F6C2}','passport control','symbols'],
    ['\u{1F6C3}','customs','symbols'],
    ['\u{1F6C4}','baggage claim','symbols'],
    ['\u{1F6C5}','left luggage','symbols'],
    ['\u{26A0}','warning','symbols'],
    ['\u{1F6B8}','children crossing','symbols'],
    ['\u{26D4}','no entry','symbols'],
    ['\u{1F6AB}','prohibited','symbols'],
    ['\u{1F6B3}','no bicycles','symbols'],
    ['\u{1F6AD}','no smoking','symbols'],
    ['\u{1F6AF}','no littering','symbols'],
    ['\u{1F6B1}','non-potable water','symbols'],
    ['\u{1F6B7}','no pedestrians','symbols'],
    ['\u{1F4F5}','no mobile phones','symbols'],
    ...
    ['\u{2934}','right arrow curving up','symbols'],
    ['\u{2935}','right arrow curving down','symbols'],
    ['\u{1F503}','clockwise vertical arrows','symbols'],
    ['\u{1F504}','counterclockwise arrows button','symbols'],
    ...
    ['\u{2626}','orthodox cross','symbols'],
    ['\u{262A}','star and crescent','symbols'],
    ['\u{262E}','peace symbol','symbols'],
    ['\u{1F54E}','dotted six-pointed star','symbols'],
    ['\u{1F52F}','dotted six-pointed star','symbols'],
    ...
    ['\u{26CE}','ophiuchus','symbols'],
    ['\u{1F500}','shuffle tracks button','symbols'],
    ['\u{1F501}','repeat button','symbols'],
    ['\u{1F502}','repeat single button','symbols'],
    ['\u{25B6}','play button','symbols'],
    ['\u{23E9}','fast-forward button','symbols'],
    ['\u{23ED}','next track button','symbols'],
    ['\u{23EF}','play or pause button','symbols'],
    ['\u{25C0}','reverse button','symbols'],
    ['\u{23EA}','fast reverse button','symbols'],
    ['\u{23EE}','last track button','symbols'],
    ['\u{1F53C}','upwards button','symbols'],
    ['\u{23EB}','fast up button','symbols'],
    ['\u{1F53D}','downwards button','symbols'],
    ['\u{23EC}','fast down button','symbols'],
    ['\u{23F8}','pause button','symbols'],
    ['\u{23F9}','stop button','symbols'],
    ['\u{23FA}','record button','symbols'],
    ['\u{23CF}','eject button','symbols'],
    ['\u{1F3A6}','cinema','symbols'],
    ['\u{1F505}','dim button','symbols'],
    ['\u{1F506}','bright button','symbols'],
    ['\u{1F4F6}','antenna bars','symbols'],
    ['\u{1F6DC}','wireless','symbols'],
    ...
    ['\u{1F7F0}','heavy equals sign','symbols'],
    ...
    ['\u{2611}','check box with check','symbols'],
    ...
    ['\u{1F538}','small orange diamond','symbols'],
    ['\u{1F539}','small blue diamond','symbols'],
    ['\u{1F53A}','red triangle pointed up','symbols'],
    ['\u{1F53B}','red triangle pointed down','symbols'],
    ['\u{1F4A0}','diamond with a dot','symbols'],
    ['\u{1F518}','radio button','symbols'],
    ['\u{1F533}','white square button','symbols'],
    ['\u{1F532}','black square button','symbols'],
    ['\u{25AA}','black small square','symbols'],
    ['\u{25AB}','white small square','symbols'],
    ['\u{25FB}','white medium square','symbols'],
    ['\u{25FC}','black medium square','symbols'],
    ['\u{25FD}','white medium-small square','symbols'],
    ['\u{25FE}','black medium-small square','symbols'],
    ...
    ['\u{1F1E6}\u{1F1F7}','flag: Argentina','flags'],
    ['\u{1F1F3}\u{1F1F1}','flag: Netherlands','flags'],
    ['\u{1F1F8}\u{1F1EA}','flag: Sweden','flags'],
    ['\u{1F1F3}\u{1F1F4}','flag: Norway','flags'],
    ['\u{1F1E9}\u{1F1F0}','flag: Denmark','flags'],
    ['\u{1F1EB}\u{1F1EE}','flag: Finland','flags'],
    ['\u{1F1F5}\u{1F1F1}','flag: Poland','flags'],
    ['\u{1F1F5}\u{1F1F9}','flag: Portugal','flags'],
    ...
    ['\u{1F1FE}\u{1F1EA}','flag: Yemen','flags'],
  ...
  var ES_CATS = [
    ...
    { id: 'animals',    label: 'Animals',    icon: '\u{1F42D}' },
    { id: 'food',       label: 'Food',       icon: '\u{1F354}' },
    { id: 'travel',     label: 'Travel',     icon: '\u{2708}' },
    { id: 'activities', label: 'Activities', icon: '\u{26BD}' },
    { id: 'objects',    label: 'Objects',    icon: '\u{1F4BB}' },
    { id: 'symbols',    label: 'Symbols',    icon: '\u{2764}' },
    { id: 'flags',      label: 'Flags',      icon: '\u{1F3F3}' },
  ];

  // People emojis that support skin tone modifiers
  var ES_TONE_BASE = [
    ...
    '\u{1F938}','\u{1F93D}','\u{1F93E}','\u{1F939}','\u{1F9D8}','\u{1F6C0}','\u{1F46E}','\u{1F477}','\u{1F482}','\u{1F385}','\u{1F9B8}','\u{1F9B9}',
    '\u{1F930}','\u{1F931}','\u{1F470}','\u{1F935}','\u{26F7}','\u{26F9}','\u{1F3CB}','\u{1F575}','\u{270B}',
  ];

  function esGetToned(e) {
    if (!ES.tone) return e;
    var base = e.replace(/[\u{1F3FB}-\u{1F3FF}]/gu, '');
    if (ES_TONE_BASE.indexOf(base) !== -1) {
      return base + String.fromCodePoint(parseInt(ES.tone, 16));
    }
    return e;
  }

  function esCodePoint(e) {
    var cps = [];
  ...
  function esLoadRecent() {
    try { ES.recent = JSON.parse(localStorage.getItem('es-recent') || '[]'); } catch(e) { ES.recent = []; }
  }

  function esSaveRecent(emoji) {
    ES.recent = [emoji].concat(ES.recent.filter(function(x) { return x !== emoji; })).slice(0, 30);
    try { localStorage.setItem('es-recent', JSON.stringify(ES.recent)); } catch(e) {}
  }

  function esRenderTabs() {
    var el = document.getElementById('es-tabs');
    if (!el) return;
    el.innerHTML = ES_CATS.map(function(c) {
      return '<button class="es-tab' + (ES.cat === c.id ? ' active' : '') + '" onclick="esSetTab(this,\'' + c.id + '\')" data-cat="' + c.id + '">' + c.icon + ' ' + c.label + '</button>';
    }).join('');
  }

  function esFilteredData() {
    var q = ES.query.trim().toLowerCase();
    return ES_DATA.filter(function(d) {
      if (ES.cat !== 'all' && d[2] !== ES.cat) return false;
  ...
  function esRender() {
    var data = esFilteredData();
    var grid = document.getElementById('es-grid');
    var empty = document.getElementById('es-empty');
    var count = document.getElementById('es-count');
    if (!grid) return;
    count.textContent = data.length + ' emoji' + (data.length !== 1 ? 's' : '');
    if (!data.length) {
      grid.innerHTML = '';
    ...
    grid.innerHTML = data.map(function(d) {
      var e = esGetToned(d[0]);
      var sel = ES.selected && ES.selected[0] === d[0];
      return '<div class="es-cell' + (sel ? ' selected' : '') + '" onclick="esSelect(' + JSON.stringify(d[0]) + ',' + JSON.stringify(d[1]) + ')" title="' + d[1] + '">' + e + '</div>';
    }).join('');
  }

  function esRenderRecent() {
    esLoadRecent();
    var box = document.getElementById('es-recent-box');
    var row = document.getElementById('es-recent-row');
    if (!box || !row) return;
    if (!ES.recent.length) { box.style.display = 'none'; return; }
    box.style.display = 'block';
    row.innerHTML = ES.recent.map(function(e) {
      return '<div class="es-cell" onclick="esSelectByChar(\'' + e + '\')" title="Recently used">' + esGetToned(e) + '</div>';
    }).join('');
  }

  function esShowDetail(e, name) {
    var toned = esGetToned(e);
    document.getElementById('es-preview').textContent = toned;
    document.getElementById('es-info-name').textContent = name.replace(/\b\w/g, function(c) { return c.toUpperCase(); });
    document.getElementById('es-info-cp').textContent = esCodePoint(toned);
    document.getElementById('es-info-html').textContent = esHtmlEntity(toned);
    document.getElementById('es-info-css').textContent = esCssVal(toned);
    var det = document.getElementById('es-detail');
    det.classList.add('visible');
  }

  window.esSelect = function(e, name) {
    ES.selected = [e, name];
    esSaveRecent(e);
    esShowDetail(e, name);
    esCopyEmoji(esGetToned(e));
    esRender();
    esRenderRecent();
  };

  window.esSelectByChar = function(e) {
    var found = ES_DATA.find(function(d) { return d[0] === e; });
  ...
  window.esCopyVal = function(id) {
    var el = document.getElementById(id);
    if (!el) return;
    var txt = el.textContent;
    if (navigator.clipboard && navigator.clipboard.writeText) {
      navigator.clipboard.writeText(txt).then(function() { esToast('Copied: ' + txt); });
    } else {
  ...
  function esCopyEmoji(e) {
    if (navigator.clipboard && navigator.clipboard.writeText) {
      navigator.clipboard.writeText(e).then(function() { esToast('Copied! ' + e); });
    } else {
      var ta = document.createElement('textarea');
  ...
  window.esCopySelected = function() {
    if (ES.selected) esCopyEmoji(esGetToned(ES.selected[0]));
  };

  function esToast(msg) {
    var t = document.getElementById('es-toast');
    t.textContent = msg;
  ...
  window.esSearch = function() {
    ES.query = document.getElementById('es-search').value;
    esRender();
  };

  window.esSetTab = function(btn, cat) {
  ...
  window.esSetTone = function(btn, tone) {
    document.querySelectorAll('.es-tone-btn').forEach(function(b) { b.classList.remove('active'); });
    btn.classList.add('active');
    ES.tone = tone;
    esRender();
    esRenderRecent();
    if (ES.selected) esShowDetail(ES.selected[0], ES.selected[1]);
  };
...
Also useful: browse Unicode symbols with our [Unicode Character Map](/tools/unicode-character-map/) or use the original [Emoji Picker](/tools/emoji-picker/) for a compact popup-style experience.
