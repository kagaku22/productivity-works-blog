---
title: "Emoji Picker - Copy & Search Emojis Free"
date: 2025-05-16
description: "Browse, search, and copy emojis by category. Includes recently used tracking, skin tone selector, and emoji info panel. Free online emoji picker tool."
...
<div class="ep-hero">
  <h1>Emoji Picker</h1>
  <p>Browse, search, and copy emojis instantly. Click any emoji to copy it.</p>
</div>

<div class="ep-info-panel" id="ep-info-panel">
  <div class="ep-info-emoji" id="ep-info-emoji"></div>
  <div class="ep-info-rows">
    <span class="ep-info-label">Name</span><span class="ep-info-value" id="ep-info-name"></span>
    <span class="ep-info-label">Unicode</span><span class="ep-info-value" id="ep-info-unicode"></span>
    <span class="ep-info-label">HTML Entity</span><span class="ep-info-value" id="ep-info-entity"></span>
    <span class="ep-info-label">Category</span><span class="ep-info-value" id="ep-info-category"></span>
  </div>
  <button class="ep-copy-btn" id="ep-copy-btn" onclick="epCopySelected()">Copy Emoji</button>
</div>

<div class="ep-controls">
  <div class="ep-search-row">
    <input class="ep-search" id="ep-search" type="text" placeholder="Search emojis..." oninput="epSearch()" autocomplete="off">
    <span class="ep-tone-label">Skin tone:</span>
    <div class="ep-tone-buttons">
      <button class="ep-tone-btn active" data-tone="" onclick="epSetTone(this, '')" title="Default">&#x270B;</button>
      <button class="ep-tone-btn" data-tone="\uD83C\uDFFB" onclick="epSetTone(this, '\uD83C\uDFFB')" title="Light" style="filter:sepia(1) saturate(3) hue-rotate(340deg);">&#x270B;</button>
      <button class="ep-tone-btn" data-tone="\uD83C\uDFFC" onclick="epSetTone(this, '\uD83C\uDFFC')" title="Medium-Light" style="filter:sepia(1) saturate(2) hue-rotate(10deg);">&#x270B;</button>
      <button class="ep-tone-btn" data-tone="\uD83C\uDFFD" onclick="epSetTone(this, '\uD83C\uDFFD')" title="Medium" style="filter:sepia(1) saturate(2) hue-rotate(350deg) brightness(0.85);">&#x270B;</button>
      <button class="ep-tone-btn" data-tone="\uD83C\uDFFE" onclick="epSetTone(this, '\uD83C\uDFFE')" title="Medium-Dark" style="filter:sepia(1) saturate(2) hue-rotate(350deg) brightness(0.65);">&#x270B;</button>
    </div>
  </div>
</div>

<div class="ep-tabs" id="ep-tabs">
  <button class="ep-tab active" data-cat="all" onclick="epSetTab(this)">All</button>
  <button class="ep-tab" data-cat="Smileys" onclick="epSetTab(this)">Smileys</button>
  <button class="ep-tab" data-cat="People" onclick="epSetTab(this)">People</button>
  <button class="ep-tab" data-cat="Animals" onclick="epSetTab(this)">Animals</button>
  <button class="ep-tab" data-cat="Food" onclick="epSetTab(this)">Food</button>
  <button class="ep-tab" data-cat="Travel" onclick="epSetTab(this)">Travel</button>
  <button class="ep-tab" data-cat="Objects" onclick="epSetTab(this)">Objects</button>
  <button class="ep-tab" data-cat="Symbols" onclick="epSetTab(this)">Symbols</button>
  <button class="ep-tab" data-cat="Flags" onclick="epSetTab(this)">Flags</button>
</div>

<div class="ep-recent" id="ep-recent-section">
  <div class="ep-section-title">Recently Used</div>
  <div class="ep-recent-grid" id="ep-recent-grid">
    <span class="ep-no-recent">No recent emojis yet</span>
  </div>
</div>

<div class="ep-grid">
  <div class="ep-section-title" id="ep-grid-title">All Emojis</div>
...
(function() {
  var EP = {
    ...
    data: [
      ...
      {e:'🧆',n:'Falafel',c:'Food'},{e:'🥚',n:'Egg',c:'Food'},
      ...
      {e:'🧭',n:'Compass',c:'Objects'},{e:'⏰',n:'Alarm Clock',c:'Objects'},
      {e:'💡',n:'Light Bulb',c:'Objects'},{e:'🔦',n:'Flashlight',c:'Objects'},
      {e:'🕯️',n:'Candle',c:'Objects'},{e:'🔋',n:'Battery',c:'Objects'},
      {e:'🔌',n:'Electric Plug',c:'Objects'},{e:'🛒',n:'Shopping Cart',c:'Objects'},
      {e:'💊',n:'Pill',c:'Objects'},{e:'💉',n:'Syringe',c:'Objects'},
      {e:'🩺',n:'Stethoscope',c:'Objects'},{e:'🩻',n:'X-Ray',c:'Objects'},
      ...
      {e:'🗝️',n:'Old Key',c:'Objects'},{e:'🔐',n:'Locked with Key',c:'Objects'},
      {e:'🔒',n:'Locked',c:'Objects'},{e:'🔓',n:'Unlocked',c:'Objects'},
      {e:'🔨',n:'Hammer',c:'Objects'},{e:'🪓',n:'Axe',c:'Objects'},
      {e:'⚙️',n:'Gear',c:'Objects'},{e:'🔧',n:'Wrench',c:'Objects'},
      {e:'🔩',n:'Nut and Bolt',c:'Objects'},{e:'🪛',n:'Screwdriver',c:'Objects'},
      {e:'🧲',n:'Magnet',c:'Objects'},{e:'🎈',n:'Balloon',c:'Objects'},
      {e:'🎉',n:'Party Popper',c:'Objects'},{e:'🎊',n:'Confetti Ball',c:'Objects'},
      {e:'🎁',n:'Wrapped Gift',c:'Objects'},{e:'🏆',n:'Trophy',c:'Objects'},
      {e:'🥇',n:'1st Place Medal',c:'Objects'},{e:'🥈',n:'2nd Place Medal',c:'Objects'},
      {e:'🥉',n:'3rd Place Medal',c:'Objects'},{e:'🎖️',n:'Military Medal',c:'Objects'},
      // Symbols
      ...
      {e:'💟',n:'Heart Decoration',c:'Symbols'},{e:'☮️',n:'Peace Symbol',c:'Symbols'},
      {e:'✝️',n:'Latin Cross',c:'Symbols'},{e:'☯️',n:'Yin Yang',c:'Symbols'},
      {e:'♻️',n:'Recycling Symbol',c:'Symbols'},{e:'⚜️',n:'Fleur-de-lis',c:'Symbols'},
      {e:'🔰',n:'Japanese Symbol for Beginner',c:'Symbols'},{e:'✅',n:'Check Mark Button',c:'Symbols'},
      {e:'❌',n:'Cross Mark',c:'Symbols'},{e:'❎',n:'Cross Mark Button',c:'Symbols'},
      {e:'🔱',n:'Trident Emblem',c:'Symbols'},{e:'⭕',n:'Hollow Red Circle',c:'Symbols'},
      {e:'🔴',n:'Red Circle',c:'Symbols'},{e:'🟠',n:'Orange Circle',c:'Symbols'},
      {e:'🟡',n:'Yellow Circle',c:'Symbols'},{e:'🟢',n:'Green Circle',c:'Symbols'},
      {e:'🔵',n:'Blue Circle',c:'Symbols'},{e:'🟣',n:'Purple Circle',c:'Symbols'},
      {e:'⚫',n:'Black Circle',c:'Symbols'},{e:'⚪',n:'White Circle',c:'Symbols'},
      {e:'🟤',n:'Brown Circle',c:'Symbols'},{e:'🔺',n:'Red Triangle Up',c:'Symbols'},
      {e:'🔻',n:'Red Triangle Down',c:'Symbols'},{e:'💠',n:'Diamond with a Dot',c:'Symbols'},
      {e:'🔷',n:'Large Blue Diamond',c:'Symbols'},{e:'🔶',n:'Large Orange Diamond',c:'Symbols'},
      {e:'⭐',n:'Star',c:'Symbols'},{e:'🌟',n:'Glowing Star',c:'Symbols'},
      {e:'💫',n:'Dizzy',c:'Symbols'},{e:'✨',n:'Sparkles',c:'Symbols'},
      {e:'🌈',n:'Rainbow',c:'Symbols'},{e:'☀️',n:'Sun',c:'Symbols'},
      {e:'🌙',n:'Crescent Moon',c:'Symbols'},{e:'⚡',n:'High Voltage',c:'Symbols'},
      {e:'❄️',n:'Snowflake',c:'Symbols'},{e:'🔥',n:'Fire',c:'Symbols'},
      {e:'💧',n:'Droplet',c:'Symbols'},{e:'🌊',n:'Water Wave',c:'Symbols'},
      {e:'🎵',n:'Musical Note',c:'Symbols'},{e:'🎶',n:'Musical Notes',c:'Symbols'},
      {e:'💯',n:'Hundred Points',c:'Symbols'},{e:'🔔',n:'Bell',c:'Symbols'},
      {e:'🔕',n:'Bell with Slash',c:'Symbols'},{e:'📣',n:'Megaphone',c:'Symbols'},
      ...
      {e:'📍',n:'Round Pushpin',c:'Symbols'},{e:'✂️',n:'Scissors',c:'Symbols'},
      {e:'🗂️',n:'Card Index Dividers',c:'Symbols'},{e:'📅',n:'Calendar',c:'Symbols'},
      {e:'⏳',n:'Hourglass Not Done',c:'Symbols'},{e:'⌛',n:'Hourglass Done',c:'Symbols'},
      {e:'🚫',n:'Prohibited',c:'Symbols'},{e:'⚠️',n:'Warning',c:'Symbols'},
      {e:'🔞',n:'No One Under Eighteen',c:'Symbols'},{e:'📵',n:'No Mobile Phones',c:'Symbols'},
      {e:'♿',n:'Wheelchair Symbol',c:'Symbols'},{e:'🆘',n:'SOS Button',c:'Symbols'},
      {e:'🆗',n:'OK Button',c:'Symbols'},{e:'🆙',n:'UP Button',c:'Symbols'},
      {e:'🆕',n:'NEW Button',c:'Symbols'},{e:'🆓',n:'FREE Button',c:'Symbols'},
      {e:'🔤',n:'Input Latin Letters',c:'Symbols'},{e:'🔡',n:'Input Latin Lowercase',c:'Symbols'},
      {e:'🔢',n:'Input Numbers',c:'Symbols'},{e:'🔣',n:'Input Symbols',c:'Symbols'},
      // Flags
      ...
      {e:'🇪🇬',n:'Flag: Egypt',c:'Flags'},{e:'🇮🇷',n:'Flag: Iran',c:'Flags'},
      {e:'🇵🇰',n:'Flag: Pakistan',c:'Flags'},{e:'🇧🇩',n:'Flag: Bangladesh',c:'Flags'},
    ...
    // People emojis that support skin tones
    toneSupport: ['👋','🤚','✋','🖖','👌','✌','🤞','🤟','🤘','👈','👉','👆','👇','☝','👍','👎','✊','👊','🤛','🤜','👏','🙌','👐','🤲','🙏','✍','💅','🤳','💪','💁','🙋','🧏','🙇','🤦','🤷','💅','🖐']
  };

  function epGetToned(emoji) {
    if (!EP.tone) return emoji;
    var base = emoji.replace(/[\uD83C][\uDFFB-\uDFFF]/g,'');
    // Only apply to people/hand emojis
    var cp = base.codePointAt(0);
    // Hand/person range roughly
  ...
  function epGetCodePoints(emoji) {
    var points = [];
  ...
  function epFiltered() {
    var q = EP.query.toLowerCase().trim();
    return EP.data.filter(function(item) {
      if (EP.cat !== 'all' && item.c !== EP.cat) return false;
  ...
  function epRender() {
    ...
    var items = epFiltered();
    var catLabel = EP.cat === 'all' ? 'All Emojis' : EP.cat;
    title.textContent = catLabel + ' (' + items.length + ')';
    if (items.length === 0) {
      grid.innerHTML = '<div class="ep-empty">No emojis found for "' + EP.query + '"</div>';
      return;
    }
    grid.innerHTML = items.map(function(item) {
      var display = epGetToned(item.e);
      return '<button class="ep-emoji-btn" title="' + item.n + '" onclick="epClick(\'' +
  ...
  function epRenderRecent() {
    ...
    var recent = epGetRecent();
    if (recent.length === 0) {
      grid.innerHTML = '<span class="ep-no-recent">No recent emojis yet</span>';
      return;
    }
    grid.innerHTML = recent.map(function(item) {
      return '<button class="ep-emoji-btn" title="' + item.n + '" onclick="epClick(\'' +
        item.e.replace(/'/g,"\\'") + '\',\'' + item.n.replace(/'/g,"\\'") + '\',\'' + item.c + '\')">' +
        epGetToned(item.e) + '</button>';
    }).join('');
  }

  function epGetRecent() {
    try {
      return JSON.parse(localStorage.getItem('ep_recent') || '[]');
    } catch(e) { return []; }
  }

  function epAddRecent(emoji, name, cat) {
    var recent = epGetRecent().filter(function(r) { return r.e !== emoji; });
    recent.unshift({e:emoji,n:name,c:cat});
    recent = recent.slice(0,24);
    try { localStorage.setItem('ep_recent', JSON.stringify(recent)); } catch(e){}
    epRenderRecent();
  }

  function epShowInfo(emoji, name, cat) {
    EP.selected = {e:emoji,n:name,c:cat};
    var panel = document.getElementById('ep-info-panel');
    panel.classList.add('visible');
    document.getElementById('ep-info-emoji').textContent = epGetToned(emoji);
    document.getElementById('ep-info-name').textContent = name;
    document.getElementById('ep-info-unicode').textContent = epGetCodePoints(emoji);
    document.getElementById('ep-info-entity').textContent = epGetEntity(emoji);
    document.getElementById('ep-info-category').textContent = cat;
  }

  window.epClick = function(emoji, name, cat) {
    epCopy(epGetToned(emoji));
    epAddRecent(emoji, name, cat);
    epShowInfo(emoji, name, cat);
  };

  window.epCopySelected = function() {
    if (EP.selected) {
      epCopy(epGetToned(EP.selected.e));
    }
  };

  function epCopy(text) {
    if (navigator.clipboard && navigator.clipboard.writeText) {
      navigator.clipboard.writeText(text).then(function() { epToast('Copied: ' + text); });
    } else {
  ...
  window.epSearch = function() {
    EP.query = document.getElementById('ep-search').value;
    epRender();
  };

  window.epSetTab = function(btn) {
    document.querySelectorAll('.ep-tab').forEach(function(b) { b.classList.remove('active'); });
    btn.classList.add('active');
    EP.cat = btn.getAttribute('data-cat');
    epRender();
  };

  window.epSetTone = function(btn, tone) {
    ...
    epRenderRecent();
    if (EP.selected) {
      document.getElementById('ep-info-emoji').textContent = epGetToned(EP.selected.e);
    }
  };
...
Related: Encode special characters with our [HTML Entity Encoder](/tools/html-entity-encoder/)
