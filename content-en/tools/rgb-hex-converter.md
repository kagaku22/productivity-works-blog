---
title: "RGB ↔ HEX Color Converter — Free Online Tool"
...
<div class="rhc-wrap">
<p class="rhc-lead">Instantly convert colors between RGB, HEX, and HSL. Use the color picker, type a HEX code, or drag the sliders — all values update live. Click any output to copy the CSS-ready value.</p>
...
<input type="color" class="rhc-color-input" id="rhcColorPick" value="#6c63ff" title="Open color picker">
...
<button class="rhc-copy-btn" data-target="rhcOutHex">Copy</button>
</div>
<div class="rhc-output-row">
<span class="rhc-output-label">RGB</span>
<span class="rhc-output-val" id="rhcOutRgb">rgb(108, 99, 255)</span>
<button class="rhc-copy-btn" data-target="rhcOutRgb">Copy</button>
</div>
<div class="rhc-output-row">
<span class="rhc-output-label">HSL</span>
<span class="rhc-output-val" id="rhcOutHsl">hsl(243, 100%, 70%)</span>
<button class="rhc-copy-btn" data-target="rhcOutHsl">Copy</button>
</div>
</div>

<!-- Color history -->
<div class="rhc-panel rhc-history">
<h3>Color History (last 10)</h3>
<div class="rhc-history-swatches" id="rhcHistory">
<span class="rhc-history-empty">No history yet — pick a color to start.</span>
</div>
</div>
</div>
...
/* gradient for S slider (reflect current H and L) */
...
if(!arr||arr.length===0){
els.histBox.innerHTML='<span class="rhc-history-empty">No history yet — pick a color to start.</span>';
return;
}
...
> Check contrast → [Contrast Checker](/tools/contrast-checker/)
> Simulate color blindness → [Color Blindness Simulator](/tools/color-blindness-simulator/)
