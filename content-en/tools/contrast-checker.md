...
ShowToc: false
cover:
  image: "/images/covers/contrast-checker.png"
---
...
<p class="cc-intro">Enter any foreground and background color to instantly calculate the WCAG 2.1 contrast ratio. See whether your color pair passes AA or AAA compliance for normal text, large text, and UI components.</p>

<div class="cc-pickers-row">
<div class="cc-picker-group">
<span class="cc-picker-label">Foreground (Text)</span>
...
<button class="cc-swap-btn" id="cc-swap" title="Swap colors" aria-label="Swap foreground and background colors">&#8644;</button>
<div class="cc-picker-group">
<span class="cc-picker-label">Background</span>
<div class="cc-picker-inner">
...
<div class="cc-ratio-tag">Maximum possible contrast</div>
</div>
<div class="cc-preview-box" id="cc-preview-box">
<div class="cc-preview-label">Live Preview</div>
<div class="cc-preview-normal" id="cc-preview-normal">Normal text sample</div>
<div class="cc-preview-large" id="cc-preview-large">Large Text Sample</div>
</div>
</div>
...
<div class="cc-section-title">Popular Color Pairs</div>
<div class="cc-suggestions" id="cc-suggestions"></div>

<div class="cc-cta-box">
<strong>Need a design tool for your team?</strong> Pair this checker with a solid project management setup. We recommend checking out tools like <a href="https://www.awin1.com/cread.php?awinmid=XXXXX&awinaffid=YYYYYY&ued=https%3A%2F%2Fwww.awin1.com%2F" target="_blank" rel="nofollow noopener">Notion for organizing your design system</a> — keeping your approved accessible color palettes documented and accessible to the whole team.
</div>

<div class="cc-related">
<h3>Related Free Tools</h3>
<div class="cc-related-links">
<a href="/tools/color-name-finder/">Color Name Finder</a>
<a href="/tools/color-blindness-simulator/">Color Blindness Simulator</a>
</div>
</div>
...
// --- Utility: hex to linear RGB luminance ---
...
// --- WCAG criteria ---
var criteria = [
{ level:'AA',  type:'normal',    label:'Normal Text',       req:4.5,  desc:'< 18pt or < 14pt bold' },
{ level:'AA',  type:'large',     label:'Large Text',        req:3.0,  desc:'18pt+ or 14pt+ bold'   },
{ level:'AA',  type:'ui',        label:'UI Components',     req:3.0,  desc:'Buttons, icons, borders'},
{ level:'AAA', type:'normal',    label:'Normal Text',       req:7.0,  desc:'Enhanced readability'  },
{ level:'AAA', type:'large',     label:'Large Text',        req:4.5,  desc:'Enhanced large text'   },
];

// --- Popular pairs ---
var suggestions = [
{ name:'Classic',    fg:'#000000', bg:'#ffffff' },
{ name:'Dark mode',  fg:'#f8f8f2', bg:'#282a36' },
{ name:'Ocean',      fg:'#ffffff', bg:'#0077b6' },
{ name:'Forest',     fg:'#ffffff', bg:'#2d6a4f' },
{ name:'Warning',    fg:'#1a1a1a', bg:'#ffc107' },
{ name:'Sky blue',   fg:'#003366', bg:'#cce5ff' },
{ name:'Charcoal',   fg:'#f5f5f5', bg:'#3a3a3a' },
{ name:'Crimson',    fg:'#ffffff', bg:'#c0392b' },
];
...
var tag = ratioDisp.nextElementSibling || ratioDisp.parentNode.querySelector('.cc-ratio-tag');
...
'<div class="cc-result-req">Requires ' + c.req.toFixed(1) + ':1 &mdash; ' + c.desc + '</div>' +
'<span class="cc-badge ' + (pass?'pass':'fail') + '">' + (pass ? 'PASS' : 'FAIL') + '</span>';
