...
<h2 class="ga-title">CSS Grid Generator</h2>
<p class="ga-subtitle">Build CSS Grid layouts visually. Adjust tracks, merge cells, add named areas, then copy your CSS.</p>

<!-- Presets -->
<div class="ga-presets">
<button class="ga-preset-btn" onclick="gaLoadPreset('dashboard')">Dashboard</button>
<button class="ga-preset-btn" onclick="gaLoadPreset('gallery')">Photo Gallery</button>
<button class="ga-preset-btn" onclick="gaLoadPreset('magazine')">Magazine Layout</button>
<button class="ga-preset-btn" onclick="gaLoadPreset('holygrail')">Holy Grail</button>
<button class="ga-preset-btn" onclick="gaLoadPreset('cards')">Responsive Cards</button>
<button class="ga-preset-btn" onclick="gaLoadPreset('reset')">Reset</button>
</div>
...
<h3>Column Track Sizes</h3>
<div class="ga-track-list" id="ga-col-tracks"></div>
</div>

<!-- Row Track Definitions -->
<div class="ga-track-section">
<h3>Row Track Sizes</h3>
<div class="ga-track-list" id="ga-row-tracks"></div>
</div>

<!-- Named Grid Areas -->
<div class="ga-areas-section">
<h3>Named Grid Areas (optional)</h3>
<p class="ga-hint">Enter one row per line. Space-separated area names. Use <code>.</code> for empty cells.</p>
<textarea id="ga-areas-input" placeholder='e.g.&#10;"header header header"&#10;"sidebar main aside"&#10;"footer footer footer"' oninput="gaUpdate()"></textarea>
</div>

<!-- Live Preview -->
<div class="ga-preview-label">Live Preview — click cells to select</div>
...
<button class="ga-add-item-btn" onclick="gaAddItem()">+ Add Item</button>
</div>

<!-- CSS Output -->
<div class="ga-output-section">
<h3>Generated CSS</h3>
<button class="ga-copy-btn" id="ga-copy-btn" onclick="gaCopyCss()">Copy CSS</button>
...
<button class="ga-copy-sh-btn" id="ga-copy-sh-btn" onclick="gaCopyShorthand()">Copy</button>
...
label.textContent = (type === 'col' ? 'Col ' : 'Row ') + (i + 1);
...
cell.textContent = item.label || ('Item ' + (idx + 1));
...
items: [
{label:'Header',color:'#6366f1',area:'header'},
{label:'Sidebar',color:'#f59e0b',area:'sidebar'},
{label:'Main',color:'#10b981',area:'main'},
{label:'Aside',color:'#8b5cf6',area:'aside'},
{label:'Footer',color:'#ef4444',area:'footer'}
]
},
gallery: {
cols: 3, rows: 3,
...
items: [
{label:'Nav',color:'#1a1a2e',area:'nav'},
{label:'Hero',color:'#6366f1',area:'hero'},
{label:'Sidebar',color:'#f59e0b',area:'sidebar'},
{label:'Article 1',color:'#10b981',area:'article1'},
{label:'Article 2',color:'#06b6d4',area:'article2'},
{label:'Footer',color:'#ef4444',area:'footer'}
]
},
holygrail: {
...
items: [
{label:'Header',color:'#6366f1',area:'header'},
{label:'Nav',color:'#f59e0b',area:'nav'},
{label:'Main',color:'#10b981',area:'main'},
{label:'Aside',color:'#8b5cf6',area:'aside'},
{label:'Footer',color:'#ef4444',area:'footer'}
]
...
setTimeout(function() { btn.textContent = 'Copy CSS'; btn.classList.remove('ga-copied'); }, 1800);
});
};
...
btn.textContent = 'Copied!';
btn.classList.add('ga-copied');
setTimeout(function() { btn.textContent = 'Copy'; btn.classList.remove('ga-copied'); }, 1800);
});
};
...
> Build Flexbox layouts → [CSS Flexbox Generator](/tools/flexbox-generator/)
