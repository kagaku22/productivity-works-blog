---
title: "Font Pair Suggester — Typography Tool"
date: 2025-05-16
...
ShowToc: false
cover:
  image: "/images/covers/font-pair-suggester.png"
  alt: "Font Pair Suggester"
---
...
<p>Choose a pairing, adjust controls, and copy your CSS — no API calls, works offline.</p>
</div>

<!-- Top bar -->
<div class="fp-topbar">
<div class="fp-preset-group" id="fp-presets">
<button class="fp-preset-btn active" data-preset="all">All</button>
<button class="fp-preset-btn" data-preset="modern">Modern</button>
<button class="fp-preset-btn" data-preset="classic">Classic</button>
<button class="fp-preset-btn" data-preset="playful">Playful</button>
<button class="fp-preset-btn" data-preset="professional">Professional</button>
<button class="fp-preset-btn" data-preset="minimal">Minimal</button>
</div>
<button class="fp-dark-toggle" id="fp-dark-toggle">Dark Mode</button>
</div>

<!-- Pair grid (rendered by JS) -->
...
<span class="fp-preview-label">Live Preview</span>
<span class="fp-pair-name" id="fp-active-pair-name">Georgia + Trebuchet MS</span>
</div>
<div class="fp-preview-area" id="fp-preview-area">
<div class="fp-preview-heading" id="fp-preview-heading">The quick brown fox</div>
<div class="fp-preview-body" id="fp-preview-body">Good typography improves readability and sets the tone of your content. Pair a strong heading font with a legible body font for best results.</div>
</div>
</div>
</div>
...
<span class="fp-css-title">CSS Output</span>
...
name: 'Futura + Georgia',
style: 'modern',
heading: { label: 'Futura', stack: 'Futura, "Century Gothic", "Apple Gothic", "Gill Sans", sans-serif' },
body:    { label: 'Georgia', stack: 'Georgia, "Times New Roman", serif' },
},
{
id: 'modern-3',
...
{
id: 'minimal-3',
name: 'Calibri + Georgia',
style: 'minimal',
heading: { label: 'Calibri', stack: 'Calibri, Candara, "Gill Sans", sans-serif' },
body:    { label: 'Georgia', stack: 'Georgia, "Times New Roman", serif' },
},
{
id: 'professional-1',
...
{
id: 'professional-4',
name: 'Century Gothic + Arial',
style: 'professional',
heading: { label: 'Century Gothic', stack: '"Century Gothic", "Apple Gothic", "Gill Sans", Futura, sans-serif' },
body:    { label: 'Arial', stack: 'Arial, Helvetica, sans-serif' },
},
{
id: 'playful-1',
...
{
id: 'playful-2',
name: 'Comic Sans + Verdana',
style: 'playful',
heading: { label: 'Comic Sans MS', stack: '"Comic Sans MS", "Comic Sans", cursive, sans-serif' },
body:    { label: 'Verdana', stack: 'Verdana, Geneva, Tahoma, sans-serif' },
},
{
id: 'playful-3',
...
style: 'minimal',
heading: { label: 'System UI (Bold)', stack: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' },
body:    { label: 'System UI', stack: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' },
},
{
id: 'modern-5',
name: 'Verdana + Palatino',
style: 'modern',
heading: { label: 'Verdana', stack: 'Verdana, Geneva, Tahoma, sans-serif' },
body:    { label: 'Palatino', stack: '"Palatino Linotype", Palatino, "Book Antiqua", Georgia, serif' },
},
{
id: 'classic-4',
...
{
id: 'modern-6',
name: 'Candara + Georgia',
style: 'modern',
heading: { label: 'Candara', stack: 'Candara, Calibri, Optima, sans-serif' },
body:    { label: 'Georgia', stack: 'Georgia, "Times New Roman", serif' },
},
];
...
<div class="fp-pair-card${p.id === activeId ? ' active' : ''}" data-id="${p.id}" role="button" tabindex="0" aria-label="Select ${p.name}">
...
<span class="fp-card-tag">${p.style}</span>
</div>
`).join('');
...
previewHeading.textContent = headingTextEl.value || 'The quick brown fox';
previewBody.textContent    = bodyTextEl.value || 'Body text sample.';
}
