---
title: "Photo Filter & Image Effects"
date: 2025-05-16
description: "Free online photo filter tool. Apply Instagram-style filters, adjust brightness, contrast, saturation, and more. Preview effects in real-time. Download edited images as PNG."
categories: ["Free Tools"]
tags: ["photo filter", "image effects", "instagram filter", "image editor", "canvas api", "free tool"]
slug: "photo-filter"
cover:
  image: "/images/covers/photo-filter.png"
  alt: "Photo Filter & Image Effects"
ShowToc: false
---
...
<div class="pf-dropzone" id="pf-dropzone">
  ...
  <p>Supports JPEG, PNG, WebP, GIF — processed locally in your browser</p>
  <button class="pf-btn-upload" id="pf-upload-btn">Choose Image</button>
...
<div class="pf-editor" id="pf-editor">
  ...
  <div class="pf-canvas-wrap" id="pf-canvas-wrap">
    <div class="pf-canvas-label" id="pf-canvas-label">Filtered</div>
  ...
  <div class="pf-panel">
    ...
    <!-- Preset Filters -->
    <div class="pf-card">
      <div class="pf-card-title">Preset Filters</div>
      <div class="pf-presets" id="pf-presets"></div>
    </div>

    <!-- Adjustments -->
    <div class="pf-card">
      <div class="pf-card-title">Adjustments</div>
      <div id="pf-sliders"></div>
    </div>

    <!-- Actions -->
    <div class="pf-card">
      <div class="pf-card-title">Actions</div>
      <div class="pf-actions">
        <label class="pf-compare-toggle">
          <input type="checkbox" id="pf-compare-chk"> Show Before / After
        </label>
        <button class="pf-btn pf-btn-primary" id="pf-download-btn">Download PNG</button>
        <button class="pf-btn pf-btn-secondary" id="pf-new-btn">Load New Image</button>
        <button class="pf-btn pf-btn-danger" id="pf-reset-btn">Reset Filters</button>
      </div>
    </div>
...
(function() {
  ...
  // ── Preset definitions ─────────────────────────────────────────────────────
  const PRESETS = [
    { name: 'Normal',    brightness:100, contrast:100, saturate:100, sepia:0,   grayscale:0,  hueRotate:0,   blur:0, invert:0, swatch:'#a78bfa' },
    { name: 'Vintage',   brightness:105, contrast:95,  saturate:75,  sepia:35,  grayscale:0,  hueRotate:0,   blur:0, invert:0, swatch:'#d97706' },
    { name: 'B&W',       brightness:100, contrast:110, saturate:0,   sepia:0,   grayscale:100,hueRotate:0,   blur:0, invert:0, swatch:'#374151' },
    { name: 'Warm',      brightness:108, contrast:100, saturate:120, sepia:20,  grayscale:0,  hueRotate:10,  blur:0, invert:0, swatch:'#f59e0b' },
    { name: 'Cool',      brightness:100, contrast:105, saturate:110, sepia:0,   grayscale:0,  hueRotate:200, blur:0, invert:0, swatch:'#3b82f6' },
    { name: 'Dramatic',  brightness:95,  contrast:140, saturate:90,  sepia:0,   grayscale:0,  hueRotate:0,   blur:0, invert:0, swatch:'#1e1b4b' },
    { name: 'Fade',      brightness:115, contrast:80,  saturate:70,  sepia:10,  grayscale:0,  hueRotate:0,   blur:0, invert:0, swatch:'#e9d5ff' },
    { name: 'Vivid',     brightness:105, contrast:115, saturate:165, sepia:0,   grayscale:0,  hueRotate:0,   blur:0, invert:0, swatch:'#ec4899' },
    { name: 'Matte',     brightness:110, contrast:90,  saturate:80,  sepia:15,  grayscale:5,  hueRotate:0,   blur:0, invert:0, swatch:'#6b7280' },
    { name: 'Sunset',    brightness:108, contrast:108, saturate:130, sepia:25,  grayscale:0,  hueRotate:340, blur:0, invert:0, swatch:'#f97316' },
    { name: 'Forest',    brightness:100, contrast:105, saturate:120, sepia:0,   grayscale:0,  hueRotate:85,  blur:0, invert:0, swatch:'#15803d' },
    { name: 'Soft Blur', brightness:100, contrast:100, saturate:100, sepia:0,   grayscale:0,  hueRotate:0,   blur:1.5,invert:0, swatch:'#c4b5fd' },
  ];
  ...
  const SLIDERS = [
    ...
    { key:'blur',       label:'Blur',       min:0,   max:10,  default:0,   unit:'px', step:0.1 },
  ...
  PRESETS.forEach(p => {
    ...
    btn.className = 'pf-preset-btn' + (p.name === 'Normal' ? ' pf-active' : '');
  ...
  function loadImage(file) {
    ...
    img.onload = function() {
      ...
      // Build orig canvas for comparison
  ...
  dlBtn.addEventListener('click', () => {
    // Render to a fresh off-screen canvas at natural res
...
> Resize photos to exact dimensions → [Image Resizer](/tools/image-resizer/)

> Pick and convert colors → [Color Picker](/tools/color-picker/)
